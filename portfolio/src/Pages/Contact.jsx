...
function Contact() {
  ...
  return (
    <>
      <h2 className="text-3xl md:text-4xl mb-6 text-center text-white m-5">Contact Me</h2>
      ...
      <div className="flex justify-center space-x-6 md:space-x-9 items-center mt-4 md:mt-0">
        <a href="https://github.com/Anshika13d" target="_blank" rel="noopener noreferrer" className="hover:text-teal-900">
          <FontAwesomeIcon icon={faGithub} className="text-white text-2xl md:text-3xl hover:text-gray-500" />
        </a>
        <a href="https://www.linkedin.com/in/anshika-das-304661246" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
          <FontAwesomeIcon icon={faLinkedin} className="text-white text-2xl md:text-3xl hover:text-gray-500" />
        </a>
        <a href="https://twitter.com/anshikad_13" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
          <FontAwesomeIcon icon={faTwitter} className="text-white text-2xl md:text-3xl hover:text-gray-500" />
        </a>
        <a href="https://www.instagram.com/_anshikha._/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
          <FontAwesomeIcon icon={faInstagram} className="text-white text-2xl md:text-3xl hover:text-gray-500" />
        </a>
      </div>

      {/* Contact Form */}
      <div className="max-w-lg mx-auto p-6 mt-8 bg-slate-800 rounded-lg text-white w-full sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12">
